# This Makefile is for the Tk::Gpack extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Tk/Gpack.pm]
#     AUTHOR => q[U-CAPITAL\Administrator <Administrator@familiehaase.de>]
#     NAME => q[Tk::Gpack]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Tk/Gpack.pm]
...
TO_INST_PM = lib/Tk/Gpack.pm

PM_TO_BLIB = lib/Tk/Gpack.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Tk/Gpack.pm $(INST_MAN3DIR)/Tk.Gpack.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Tk/Gpack.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Tk-Gpack' >> META.yml
	$(NOECHO) $(ECHO) 'version:      undef' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Tk/Gpack.pm' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Abbreviated geometry arguments for pack, grid and place geometry managers.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>U-CAPITAL\Administrator &lt;Administrator@familiehaase.de&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Tk/Gpack.pm blib/lib/Tk/Gpack.pm 
	$(NOECHO) $(TOUCH) $@
